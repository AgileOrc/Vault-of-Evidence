    ...
    return (
        <main className='flex min-h-screen bg-linear-to-br from-[#0EB8DF] to-[#0E5998]'>
            ...
            <section className='flex w-4/7 flex-col justify-center gap-y-36 px-14 py-12 text-white'>
                ...
                <div className='flex flex-1 flex-col px-6'>
                    <h1 className='mb-6 text-5xl font-semibold font-montserrat leading-tight'>
                        Join the Vault, <br/> Secure Your Findings.
                    </h1>

                    <p className='max-w-xl text-2xl font-montserrat font-medium text-white'>
                        Create an account to start managing your penetration testing workflows.
                    </p>
                </div>
            </section>
            ...
            <section className='flex w-3/7 items-center justify-center px-10'>
                <div className='flex flex-col gap-y-8 px-14 py-14 w-xl max-w-xl rounded-[40px] border border-white/40 bg-linear-to-br from-white/20 to-white/10 shadow-lg shadow-black/5 backdrop-blur-md'>
                    <div className='flex flex-col'>
                        <h2 className='text-[2.5rem] font-montserrat font-bold text-white leading-tight mb-2'>
                            Create Account
                        </h2>
                    ...
                    {/* Sign-In Link */}
                    <p className='text-center text-lg font-montserrat font-medium text-white mt-2'>
                    ...
                    <Link
                        to='/Dashboard'
                        className='w-fit rounded-xl bg-[#41B0EC] mx-auto py-2 px-6 text-center text-xl font-montserrat font-semibold text-white hover:bg-white hover:text-[#41B0EC] hover:border hover:border-[#41B0EC] transition-colors'
                    >
                        Sign Up
                    </Link>
                </div>
