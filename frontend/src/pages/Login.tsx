...
function Login() {
    ...
    return (
        <main className='flex min-h-screen items-start pt-20 bg-linear-to-br from-[#27D6FF] to-[#1767AA]'>
            {/* Left Side */}
                ...
                >
                    ...
                    <div className='flex flex-col gap-y-1 lg:text-sm xl:text-lg'>
                        <div className='flex items-center justify-between'>
                            ...
                            <Link to='/reset-password' className='font-montserrat font-semibold text-white hover:text-[#27D6FF]'>
                                Forgot Password?
                            </Link>
                        </div>
                        <input
                    ...
                    <button
                        type="submit"
                        disabled={isLoading}
                        className={`w-fit lg:rounded-lg xl:rounded-xl bg-[#20A6DA] mx-auto lg:px-4 lg:py-1 xl:px-6 xl:py-2 text-center lg:text-md xl:text-xl font-montserrat font-semibold text-white transition-all hover:bg-white hover:text-[#002C49] hover:bg-[#27D6FF] hover:border hover:border-[#27D6FF] ${
