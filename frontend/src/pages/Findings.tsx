    ...
    <div className="h-full flex flex-col">
      <div className="mb-6 flex justify-between items-center shrink-0">
        ...
        <div className="flex gap-3">
          ...
          <Link to="/Findings/New" className="bg-[#1767AA] hover:bg-[#002C49] text-white px-6 py-2 rounded-lg font-medium transition-colors cursor-pointer text-center">
            + Add Finding
          </Link>
        </div>
      </div>
      ...
      <div className="bg-white p-4 rounded-t-xl border border-gray-200 border-b-0 flex items-center justify-between shrink-0">
        <div className="relative w-80">
          ...
          <input 
            ...
            className="w-full pl-10 pr-4 py-2 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#20A6DA] text-sm"
          />
        </div>
          ...
          <thead className="bg-gray-50 text-gray-500 text-sm sticky top-0 z-10">
            <tr>
              <th className="px-6 py-4 font-medium border-b border-gray-200 w-12">
                <input type="checkbox" className="rounded border-gray-300 text-[#1767AA] focus:ring-[#1767AA]" />
              </th>
      ...
      <div className="bg-white border text-sm border-gray-200 border-t-0 rounded-b-xl p-4 flex justify-between items-center text-gray-500 shrink-0">
        ...
        <div className="flex gap-1">
          ...
          <button className="px-3 py-1 border border-[#1767AA] bg-[#1767AA] text-white rounded-md cursor-pointer">1</button>
