            ...
            <div className='flex flex-col items-center lg:gap-y-6 xl:gap-y-8'>
                ...
                >
                    ...
                    <button
                        type='submit'
                        disabled={isLoading}
                        className={`w-fit lg:rounded-lg xl:rounded-xl bg-[#20A6DA] mx-auto lg:px-6 lg:py-2 xl:px-8 xl:py-3 text-center lg:text-md xl:text-xl font-montserrat font-semibold text-white transition-all hover:bg-white hover:text-[#002C49] hover:bg-[#27D6FF] hover:border hover:border-[#27D6FF] ${
