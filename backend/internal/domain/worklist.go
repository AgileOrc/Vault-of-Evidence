...
const (
	WorklistOpen       WorklistStatus = "open"
...
type Worklist struct {
	...
	Status      WorklistStatus `gorm:"type:varchar(20);not null;default:'open'"       json:"status"`
...
type UpdateWorklistRequest struct {
	...
	Status      WorklistStatus `json:"status"      binding:"omitempty,oneof=open in_progress completed"`
}